...
public class CreateMJpeg {
    ...
    public static void jpg2mjpeg(String path, String suffix, String nameOfFile) throws Exception {
        ...
        DataOutputStream out = new DataOutputStream(
                new FileOutputStream(directory.getPath() + "/" + nameOfFile + ".mjpeg"));
        for (String n : list) {
    ...
    public static void main(String args[]) throws Exception {
        String path = "E:/java/pic/ZED/staet";
        String suffix = "L.jpg";
        String nameOfFile = "movieL";
        jpg2mjpeg(path, suffix, nameOfFile);
    }
}